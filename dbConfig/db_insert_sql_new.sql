...
INSERT INTO exercise (name, target_muscle, level, description) values ('Lat pulldown', 'Lats', 2, 'Pull a wheight/rope down from above your head down to your chest, gently raise the bar again and repeat.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Deadlift', 'Low Back', 4, 'Stand with your feet about shoulder-width apart. Pull a barbell up from the floor while keeping your back arched and knees bent.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Seated row', 'Low Back', 1, 'Sit with back tall, arms straight out and holding on to the handles. Using your back pull the tubing, bending at the elbows, keeping a 90 degree angle');
INSERT INTO exercise (name, target_muscle, level, description) values ('Upper back row', 'Lats', 1, 'Sit with back tall, arms straight out and holding onto the handles, palms facing down. Keeping elbows up and using your back, bend the elbows back to a 90 degree angle.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Bent over fly', 'Low Back', 1, ': Bend at the hip, flat back, arms straight down. Using your mid back with arms slightly bent; raise your hands out to the side while keeping your back flat.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Pull up', 'Lats', 1, 'Grab a horizontal bar above your head wider than shoulder-width apart. Lift yourself up until your chin is level with the bar. Gently lower yourself again and repeat.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Push up', 'Pecs', 2, 'On your toes and hands placed a bit wider than shoulder width and in line with the chest, fingers facing forward');
INSERT INTO exercise (name, target_muscle, level, description) values ('Chest press', 'Pecs', 1, 'Stand/sit with your back to a wall, tubing or weights in both hands, arms bent at a 90 degree angle, palms facing down. Using the chest muscle, press arms straight forward to in front of the chest');
INSERT INTO exercise (name, target_muscle, level, description) values ('Decline chest press', 'Pecs', 2, 'Stand/sit with your back to the door, tubing or weights in both hands, arms bent at a 90 degree angle, palms facing down, and arms in line with the tubing. Using the chest muscle, press arms straight forward toward the ground, just below the chest.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Elevated push up', 'Pecs', 3, 'With your feet on a chair, bench, books or box and hands placed a bit wider than shoulder width and in line with the chest, fingers facing forward. Bend the elbows to a 90 degree angle, lowering the chest toward the ground, keeping your back flat.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Bench press', 'Pecs', 2, 'Lie down on a bench with a barbell. Grip the barbell slightly wider than shoulder-width. Bring the barbell down to your chest and lift it up again until your arms are straight while keeping your back arched.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Standing shoulder press', 'Traps', 2, 'Stand tall and grab a dumbbell in each hand. Start by holding the dumbbells shoulder high with your elbow in a 90-degree angle. Raise your arms above your head until they are straight and back down again to a 90-degree angle.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Lateral raise', 'Traps', 2, 'Stand with weights in both hands, arms at side with palms facing in. Using your shoulders, lift arms out to side up to shoulder height, keeping a slight bend in the elbow');
INSERT INTO exercise (name, target_muscle, level, description) values ('Seated front raise', 'Delts', 2, 'Sit tall with feet together, arms at the side, palms facing forward. Using the front of the shoulder, lift the arm forward, up in front of the body with a slight bend in the elbow');
INSERT INTO exercise (name, target_muscle, level, description) values ('External rotation', 'Delts', 2, 'With the working elbow at your side, arm at a 90 degree angle in front of the body holding the tubing handle. Using your shoulder and keeping the elbow at the side rotate the arm out to create a 90 degree angle to the outside.');
...
INSERT INTO exercise (name, target_muscle, level, description) values ('Bicep curl', 'Biceps', 1, 'Stand with feet hip width apart, hand on handles at side, palms facing forward. Contract the bicep muscle, bending at the elbow, bringing the hand towards the shoulder');
INSERT INTO exercise (name, target_muscle, level, description) values ('Concentration curl', 'Biceps', 1, 'Place elbow inside one knee/leg holding handle, palm facing up. Contract bicep bringing hand toward the shoulder as elbow stays in contact with the leg.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Tricep pushdown', 'Triceps', 1, 'Stand with feet hip width apart, elbows at your side, palms facing down. Contracting the triceps, straighten the arm bringing your arms straight to your side.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Tricep extension', 'Triceps', 1, 'With one hand holding the wheight behind your back. Using the triceps muscle, straighten the upper arm then lower back down to start position');
INSERT INTO exercise (name, target_muscle, level, description) values ('Leg curl', 'Hamstring', 1, 'Stand with feet together facing the door and a band wrapped around ankle or foot. Using the hamstring and keeping the knees together, lift the lower leg and foot toward your glutes.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Hamstring pull down', 'Hamstring', 1, 'Lie on your back, leg with the tubing in the air, the other is bent with the foot flat on the floor. Using your hamstrings and keeping the leg straight lower the leg to the floor.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Standing cross over', 'Hamstring', 1, 'Stand parallel to the door, band around ankle closest to the door. Using the inner thigh, cross the leg with the band in front of the body.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Inner thigh leg lift', 'Hamstring', 1, 'On your side, head propped up, bottom leg straight, top leg bent with foot on floor and next to knee.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Kickback', 'Glutes', 1, 'On all fours with hands directly under your shoulders holding on to the ends of the band. The center of the band is wrapped around one of the feet. Using your Glutes push the leg back straight, making sure there is tension on the band.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Side leg lift', 'Glutes', 1, 'Lying on your side, bottom leg straight top leg straight out in front of you. Using the top leg and hip, keeping the leg straight, lift straight up in front of you.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Squat', 'Quads', 2, 'Put a barbell behind your neck across the top of your back and grip the bar wider than shoulder-width. Squat down so the hips are level with your knees and rise again while keeping your back straight.');
INSERT INTO exercise (name, target_muscle, level, description) values ('Lunge', 'Quads', 1, 'Stand in a split stance, toes facing forward. Bend both knees and lower to the ground, back heel will come off the floor');
